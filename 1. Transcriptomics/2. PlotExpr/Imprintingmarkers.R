...
#==============================================================================#
# select genes
test <- geneAnnotation[which(str_detect(geneAnnotation$GeneName, "MEG9")),]
# ENSG00000214548_MEG3
# ENSG00000225746_MEG8
# ENSG00000278318_ZNF229
# ENSG00000106484_MEST

selectedGene <- "ENSG00000214548_MEG3"
#==============================================================================#
...
# Save plot
ggsave(finalPlot, file = paste0("Imprinting markers/", nameGene,".png"), width = 6, height = 4)
