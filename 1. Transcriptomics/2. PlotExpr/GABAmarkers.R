...
# Filter for Ventral region only
plotDF <- plotDF[plotDF$Tissue != "Dorsal",]
plotDF1 <- plotDF1[plotDF1$Tissue != "Dorsal",]
...
# Save plot
ggsave(finalPlot, file = paste0("GABAmarkers/", nameGene,".png"), width = 6, height = 4)
